...
class SkillManager(private val plugin:Plugin) {
    ...
    private fun registerSkill(skill: ISkill) {
        ...
        if (skillClass.isAnnotationPresent(de.butterfly.butterflyapi.annotation.SkillInformation::class.java)) {
    ...
    fun getSkillInfo(skillClass:Class<*>):String {
        ...
        val  annotation = skillClass.getAnnotation(de.butterfly.butterflyapi.annotation.SkillInformation::class.java)
    ...
    fun canFuse(skillClass: Class<*>): Boolean {
        val skillInfo = skillClass.getAnnotation(de.butterfly.butterflyapi.annotation.SkillInformation::class.java)
