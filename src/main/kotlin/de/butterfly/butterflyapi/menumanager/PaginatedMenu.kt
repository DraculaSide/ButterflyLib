...
@Suppress("unused")
abstract class PaginatedMenu(override var playerMenuUtility: de.butterfly.butterflyapi.menumanager.PlayerMenuUtility?) : de.butterfly.butterflyapi.menumanager.MenuManager(playerMenuUtility) {
